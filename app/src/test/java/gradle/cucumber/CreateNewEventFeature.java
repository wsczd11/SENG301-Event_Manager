...
public class CreateNewEventFeature {
  ...
  public void i_expect_an_exception_that_disallow_me_to_create_any_of_those() {
    Assertions.assertThrows(IllegalArgumentException.class, () ->
            eventHandler.createEvent("first event", "some description", firstEventDate, "some type"));
    Assertions.assertThrows(IllegalArgumentException.class, () ->
            eventHandler.createEvent("second event", "some description", secondEventDate, "some type"));
  }
}
